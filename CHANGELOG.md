...
- fix: changelog ([#17021](https://github.com/MetaMask/metamask-mobile/pull/17021))
- fix: changelog issue ([#17018](https://github.com/MetaMask/metamask-mobile/pull/17018))
- fix: remove identity E2Es test specific mock server ports ([#16904](https://github.com/MetaMask/metamask-mobile/pull/16904))
- fix: Design QA Bugs 2 ([#16737](https://github.com/MetaMask/metamask-mobile/pull/16737))
- fix: cp-7.50.0 removed local flag and regression on LD flag key ([#16903](https://github.com/MetaMask/metamask-mobile/pull/16903))
- fix: Fix bottom modal flicker ([#16886](https://github.com/MetaMask/metamask-mobile/pull/16886))
- fix: cp-7.50.0 change in LD flag Key ID ([#16871](https://github.com/MetaMask/metamask-mobile/pull/16871))
- fix: only showing 30 tokens for evm ([#16812](https://github.com/MetaMask/metamask-mobile/pull/16812))
- fix: cp-7.50.0 Earn lending blocking UI tweaks ([#16844](https://github.com/MetaMask/metamask-mobile/pull/16844))
- fix: Describe what happened modal is incorrectly displayed in dark mode ([#16589](https://github.com/MetaMask/metamask-mobile/pull/16589))
- fix: Sentry issue "null is not an object" in WebsiteIcon/index.js, line 116: getHost(url).substring(0, 1); ([#16835](https://github.com/MetaMask/metamask-mobile/pull/16835))
- fix: cp-7.50.0 restore deleted backupAndSync keys ([#16788](https://github.com/MetaMask/metamask-mobile/pull/16788))
- fix: cp-7.50.0 batch approval broken for unlimited approvals ([#16786](https://github.com/MetaMask/metamask-mobile/pull/16786))
- fix: Bump version of React-native-webview-mm to 14.2.2 to include fixes for Blob file downloading on both platforms ([#16803](https://github.com/MetaMask/metamask-mobile/pull/16803))
- fix: spelling of "steal" in private key warnings in English locale ([#16789](https://github.com/MetaMask/metamask-mobile/pull/16789))
- fix: not going to bridge tx details for sol swaps ([#16771](https://github.com/MetaMask/metamask-mobile/pull/16771))
- fix: display amount for nested transaction in advance view ([#16669](https://github.com/MetaMask/metamask-mobile/pull/16669))
- fix: cp-7.50.0 Gas fee is now sent to tx controller as hex or undefined ([#16761](https://github.com/MetaMask/metamask-mobile/pull/16761))
- fix: cp-7.50.0 TAT-927: USDT allowance increase on deposit confirmation screen hangs ([#16689](https://github.com/MetaMask/metamask-mobile/pull/16689))
- fix: cp-7.50.0 Mitigate flash of safe withdrawal limit message ([#16727](https://github.com/MetaMask/metamask-mobile/pull/16727))
- fix: Remove QA team entries from CODEOWNERS ([#16750](https://github.com/MetaMask/metamask-mobile/pull/16750))
- fix: cp-7.50.0 Remove lending earnings history button ([#16648](https://github.com/MetaMask/metamask-mobile/pull/16648))
- fix: Addressing UI feedbacks in 7702 functionality ([#16740](https://github.com/MetaMask/metamask-mobile/pull/16740))
- fix: cp-7.50.0 Hide simulations MM originated confirmations ([#16717](https://github.com/MetaMask/metamask-mobile/pull/16717))
- fix: cp-7.50.0 adding send button to Solana asset screen ([#15799](https://github.com/MetaMask/metamask-mobile/pull/15799))
- fix: cp-7.50.0 quarantine analytics e2e test ([#16741](https://github.com/MetaMask/metamask-mobile/pull/16741))
- fix: Design QA Bugs cp-7.50.0 ([#16655](https://github.com/MetaMask/metamask-mobile/pull/16655))
- fix: cp-7.50.0 fix infinite loader and inconsistent `completedOnboarding` value ([#16695](https://github.com/MetaMask/metamask-mobile/pull/16695))
- fix: cp-7.50.0 not redirecting to Solana Swaps UI from Legacy Swaps if they select a Solana account ([#16605](https://github.com/MetaMask/metamask-mobile/pull/16605))
- fix: correct switch / switch back labels in account modal to switch account type ([#16675](https://github.com/MetaMask/metamask-mobile/pull/16675))
- fix: cp-7.50.0 Prevent cronjob state from getting out of sync ([#16711](https://github.com/MetaMask/metamask-mobile/pull/16711))
- fix: wallet connect QR code reading failure ([#16684](https://github.com/MetaMask/metamask-mobile/pull/16684))
- fix: Switch to smart account action should not be available for hardware wallet accounts ([#16692](https://github.com/MetaMask/metamask-mobile/pull/16692))
- fix: Exclude smart transaction approval requests from rate limiting ([#16619](https://github.com/MetaMask/metamask-mobile/pull/16619))
- fix: cp-7.50.0 fix refresh calls ([#16694](https://github.com/MetaMask/metamask-mobile/pull/16694))
- fix: cp-7.47.2 account address missmatch with identity ([#16674](https://github.com/MetaMask/metamask-mobile/pull/16674))
- fix: snaps unable to call wallet_switchEthereumChain when they have no accounts permitted ([#16377](https://github.com/MetaMask/metamask-mobile/pull/16377))
- fix: Fix/bottom sheet notch padding ([#16649](https://github.com/MetaMask/metamask-mobile/pull/16649))
- fix: cp-7.50.0 Fix redesigned transaction confirmations after rejecting legacy transaction confirmation ([#16654](https://github.com/MetaMask/metamask-mobile/pull/16654))
- fix: 13165 fix ledger blind sign error displayed not correctly ([#16200](https://github.com/MetaMask/metamask-mobile/pull/16200))
- fix: Import srp error issue cp-7.50.0 ([#16621](https://github.com/MetaMask/metamask-mobile/pull/16621))
- fix: Pass proper arguments in `eth_requestAccounts` implementation ([#16664](https://github.com/MetaMask/metamask-mobile/pull/16664))
- fix: cp-7.50.0 Fix signed or submitted alert and nonce selection ([#16600](https://github.com/MetaMask/metamask-mobile/pull/16600))
- fix: cp-7.50.0 add control bar for networks with no positions ([#16597](https://github.com/MetaMask/metamask-mobile/pull/16597))
- fix: nit pick unit test for method `isValidNetworkName` ([#14500](https://github.com/MetaMask/metamask-mobile/pull/14500))
- fix: Undefined ticker on activity list ([#16626](https://github.com/MetaMask/metamask-mobile/pull/16626))
- fix: default to main code fence and opt-in for beta ([#16599](https://github.com/MetaMask/metamask-mobile/pull/16599))
- fix: Cleanup duplicate wallet permission handlers in BackgroundBridge. Fix incorrect wallet permission handlers in SnapBridge ([#16002](https://github.com/MetaMask/metamask-mobile/pull/16002))
- fix: cp-7.50.0 subscribe notifications on app startup. ([#16547](https://github.com/MetaMask/metamask-mobile/pull/16547))
- fix: Fix `getItemLayout` parameters ([#16615](https://github.com/MetaMask/metamask-mobile/pull/16615))
- fix: cp-7.50.0 bump @metamask/multichain-api-client to 0.6.3 to handle multichain api not responding on page load ([#16590](https://github.com/MetaMask/metamask-mobile/pull/16590))
- fix: Remove delay for dispatch of INIT_BG_STATE_KEY ([#16602](https://github.com/MetaMask/metamask-mobile/pull/16602))
- fix: cp-7.50.0 use actual origin for `MultichainRouter:handleRequest` call in Multichain API ([#16565](https://github.com/MetaMask/metamask-mobile/pull/16565))
- fix: reveal private credential screen scroll ([#16445](https://github.com/MetaMask/metamask-mobile/pull/16445))
- fix: secure text on blur ([#16461](https://github.com/MetaMask/metamask-mobile/pull/16461))
- fix: migration 085 bug ([#16572](https://github.com/MetaMask/metamask-mobile/pull/16572))
- fix: cp-7.50.0 Fix `ApprovalTagUrl` exception for legacy confirmations ([#16495](https://github.com/MetaMask/metamask-mobile/pull/16495))
- fix: adjust ui entry point logic to work for diff flag variations ([#16512](https://github.com/MetaMask/metamask-mobile/pull/16512))
- fix: turn off autofill (autocomplete) workaround ([#16523](https://github.com/MetaMask/metamask-mobile/pull/16523))
- fix: cp-7.50.0 Fix contract interaction metrics ([#16525](https://github.com/MetaMask/metamask-mobile/pull/16525))
- fix: SuccessErrorSheet Icon Update ([#16511](https://github.com/MetaMask/metamask-mobile/pull/16511))
