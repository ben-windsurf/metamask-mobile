    ...
    case 'SET_HIDE_ZERO_BALANCE_TOKENS':
      return {
        ...
        hideZeroBalanceTokens:
          action.hideZeroBalanceTokens ?? state.hideZeroBalanceTokens,
      };
    case 'SET_USE_BLOCKIE_ICON':
      return {
        ...state,
        useBlockieIcon: action.useBlockieIcon ?? state.useBlockieIcon,
      };
    ...
    case 'TOGGLE_BASIC_FUNCTIONALITY':
      return {
        ...
        basicFunctionalityEnabled:
          action.basicFunctionalityEnabled ?? state.basicFunctionalityEnabled,
      };
    ...
    case 'SET_DEEP_LINK_MODAL_DISABLED':
      return {
        ...
        deepLinkModalDisabled:
          action.deepLinkModalDisabled ?? state.deepLinkModalDisabled,
      };
    default:
      return state;
  }
